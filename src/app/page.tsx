      ...
      <section style={{
        ...
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '16px', color: 'var(--texte-muted)', lineHeight: 1.7, marginBottom: '32px' }}>
            Cours audio, khoutbah, conférences, fatwas et heures de prières —<br />
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/prieres" style={{ border: '1.5px solid var(--or)', color: 'var(--or-fonce)', padding: '13px 28px', borderRadius: '8px', fontSize: '15px', fontWeight: 500 }}>
              Heures de prières
            </Link>
          </div>
        </div>
