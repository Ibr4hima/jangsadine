...
export default function PageKhoutbah() {
  ...
  if (!khoutbah) return <main style={{ minHeight: '100vh', background: 'var(--fond-creme)' }}><Navbar /><div style={{ textAlign: 'center', padding: '80px 24px', color: '#aaa' }}>Introuvable</div></main>
